...
## New version
MeDuSA now also supports cell-state deconvolution for annotated discrete `cell states (cell types)`. Please check the [MeDuSAJ](https://github.com/LeonSong1995/MeDuSAJ). 
